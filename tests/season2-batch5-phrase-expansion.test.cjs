...
assert.equal(phraseIds.size,3924);
assert.equal(Math.max(...phrases.map(phrase=>Number(phrase.id.slice(1)))),4051);
...
assert.deepEqual(counts(newPhrases,"episode"),{"S01E01":2,"S01E02":7,"S01E04":2,"S01E05":2,"S01E06":1,"S01E07":3,"S01E09":3,"S01E13":1,"S01E14":1,"S01E18":1,"S01E19":1,"S01E20":1,"S01E22":2,"S02E01":2,"S02E03":1,"S02E04":1,"S02E05":1,"S02E06":1,"S02E09":1,"S02E10":1,"S02E13":31,"S02E14":40,"S02E15":29});
...
assert.equal(newPhrases.filter(phrase=>Object.prototype.hasOwnProperty.call(phrase,"note")).length,26);
...
assert.equal(findNew("Nice to meet you. / Good to meet you.")?.id,"p1880");
...
assert.equal(
  ...
  "8c3289733bdf9cef958b7af354fc74dfffb35629edc6e6d8272f992b8349c2d2"
);
...
assert.equal(dialogues.length,326);
assert.equal(crypto.createHash("sha256").update(JSON.stringify(dialogues)).digest("hex"),"1329bdf07f5b5364ee5d605ea3f49aea749c9ea43e3c1fe45dd577218d5da62b");
