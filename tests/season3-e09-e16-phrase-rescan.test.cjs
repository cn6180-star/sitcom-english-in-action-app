...
assert.equal(byId.size,3591,'duplicate Phrase ID');
assert.equal(Math.max(...phrases.map(record=>Number(record.id.slice(1)))),3649);
...
for(const [season,want] of Object.entries({
  ...
  4:'cee4ed3b6c7cef47c0cde5d82a5fbdc28d380ceeb11fec790ab5945cf54260ae',
  5:'291b432e087a4d95b5dd8fc5460bf60b97ff79a9c1b1b4c200be817213b96d25',
