...
assert.equal(ordered.length,3902);
// Golden by ref from Astra_S1_E07-E15_Source_Order_Implementation_Package.json.
assert.equal(hash(ordered.map(p=>[p.id,p.episode,p.sourceOrder])),"bc1f73487235670e8837d0dd40e75d28db38261f46c4276c5ca6fc406388b53c");
...
assert.equal(context.filteredPhrases().length,3946);
