...
assert.equal(phrases.length,3360);assert.equal(phraseById.size,3360);
...
assert.equal(rows.length,2233);assert.deepEqual({fullAuto,fullExplicit,excluded},{fullAuto:1978,fullExplicit:249,excluded:6});
